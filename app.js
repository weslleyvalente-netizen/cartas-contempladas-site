            ...
            container.innerHTML = cartasFiltradas.map(carta => `
                <div class="card ${carta.entrada_baixa ? 'entrada-baixa' : ''}" data-id="${carta.id}">
                    ...
                    <div class="card-header">
                        <div class="card-title">Cota ${formatarNumeroCarta(carta.numero)}</div>
        ...
        function calcularJuncao() {
            ...
            mostrarResultado({
                ...
                cotasIds: cartasJuncao.map(c => formatarNumeroCarta(c.numero)).join(', ')
            });
        }
        ...
        function mostrarResultado(resultado) {
            ...
            content.innerHTML = `
                ...
                <div class="result-section">
                    ...
                    <div>${resultado.cartas.map(c => formatarNumeroCarta(c.numero)).join(', ')}</div>
                </div>
                <div class="result-section">
                    <h4>📆 Vencimento:</h4>
        ...
        function renderizarCombinacoes(combinacoes) {
            ...
            container.innerHTML = combinacoes.map((comb, index) => {
                ...
                <div class="card" style="border-color: var(--color-teal-500); border-width: 2px;">
                    ...
                    <div class="card-info">📋 Cotas: <strong>${comb.cotas.map(c => formatarNumeroCarta(c.numero)).join(', ')}</strong></div>
