...
describe('mesclarCartas', () => {
  ...
  it('aplica o ágio à entrada das cartas de parceiros ativos', () => {
    const cartasParceiros = [
      { id: 10, parceiro_id: 1, credito: 20000, entrada: 9000, agio: null, prazo: 30, parcela: 500, vencimento: '20/08/2026', administradora: 'YAMAHA' }
    ];
  ...
  it('omite cartas de parceiros desligados (ativo=false)', () => {
    const cartasParceiros = [
      { id: 11, parceiro_id: 2, credito: 20000, entrada: 9000, agio: null, prazo: 30, parcela: 500, vencimento: '20/08/2026', administradora: 'YAMAHA' }
    ];
    const resultado = mesclarCartas({ cartasParceiros, parceiros, cartasProprias: [], agioPadraoGlobal: 400 });
    expect(resultado).toHaveLength(0);
  });

  it('inclui cartas próprias sem ágio, com id deslocado e data formatada', () => {
    const cartasProprias = [
      { id: 5, credito: 30000, entrada: 15000, prazo: 24, parcela: 1200, vencimento: '2026-09-12', administradora: 'HONDA' }
    ];
    const resultado = mesclarCartas({ cartasParceiros: [], parceiros, cartasProprias, agioPadraoGlobal: 400 });
    expect(resultado).toHaveLength(1);
  ...
  it('marca entrada_baixa quando entrada/credito < 0.3', () => {
    const cartasProprias = [
      { id: 1, credito: 20000, entrada: 5000, prazo: 24, parcela: 800, vencimento: '2026-01-01', administradora: 'HONDA' }
    ];
